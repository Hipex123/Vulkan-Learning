...
const std::string MODEL_PATH = findResourcePath("/Models/modelOne.obj");
const std::string TEXTURE_PATH = findResourcePath("/Textures/textureOne.jpg");
...
public:
    ...
    int animTimeAcceleration;
    int animSpeed;

    glm::vec3 rotationAxis;
    glm::vec3 camPosition;
    glm::vec3 camLookCords;

    float FOV;
    float nearClippingPlane;
    float farClippingPlane;
    float minTextureQuality;

    App(const char *titleP = "App", int widthP = 500, int heightP = 500, int animTimeAccelerationP = 0, int animSpeedP = 1,
        glm::vec3 rotationAxisP = glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3 camPositionP = glm::vec3(2.0f, 2.0f, 2.0f),
        glm::vec3 camLookCordsP = glm::vec3(0.0f, 0.0f, 0.0f), float FOVp = 45.0f, float nearClippingPlaneP = 0.1f,
        float farClippingPlaneP = 30.0f, float minTextureQualityP = 0.0f)
    {
        title = titleP;
        width = widthP;
        height = heightP;
        animTimeAcceleration = animTimeAccelerationP + 1;
        animSpeed = animSpeedP;
        rotationAxis = rotationAxisP;
        camPosition = camPositionP;
        camLookCords = camLookCordsP;
        FOV = FOVp;
        nearClippingPlane = nearClippingPlaneP;
        farClippingPlane = farClippingPlaneP;
        minTextureQuality = minTextureQualityP;
    }
...
private:
    ...
    void createTextureSampler()
    {
        ...
        samplerInfo.minLod = minTextureQuality;
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        time = pow(time, animTimeAcceleration);
        time *= animSpeed;

        glm::mat4 modelMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));

        modelMatrix = glm::rotate(modelMatrix, time * glm::radians(45.0f), rotationAxis);

        UniformBufferObject ubo{};
        ubo.model = modelMatrix;
        ubo.view = glm::lookAt(camPosition, camLookCords, glm::vec3(0.0f, 0.0f, 1.0f));
...
int main()
{
    App app("App", 500, 500, 0, 1, glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), 60.0f, 0.1f, 30.0f, 0.0f);
...
// In create pipeline under multiSampeling there is
// multisampling.minSampleShading = .2f; // min fraction for sample shading; closer to one is smoother